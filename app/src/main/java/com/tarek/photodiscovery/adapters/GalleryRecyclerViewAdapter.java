...
public class GalleryRecyclerViewAdapter
    extends RecyclerView.Adapter<GalleryRecyclerViewAdapter.ViewHolder> {
  ...
  @Override public void onBindViewHolder(ViewHolder holder, int position) {
    ...
    LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(mColumnWidth,
        (int) (photoList.get(position).getAspectRatio() * mColumnWidth));
